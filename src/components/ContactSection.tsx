...
import { Phone, Mail, MapPin, Instagram, Facebook, Clock, MessageCircle, Send } from "lucide-react";
...
export const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const text = `Hi! I'm ${formData.name.trim()}%0APhone: ${formData.phone.trim()}%0A%0A${encodeURIComponent(formData.message.trim())}`;
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto mb-12">
          ...
          <div className="glass-card p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="font-script text-3xl text-foreground">Message Us</h3>
          ...
          <div className="glass-card p-8 bg-gradient-royal text-primary-foreground md:col-span-2 lg:col-span-1">
            ...
            <div className="space-y-3">
              <Button 
                ...
                onClick={() => window.open("https://wa.me/917003306599", "_blank")}
              >
