...
export const HeroSection = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-pink pt-20"
    >
      <Sparkles />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card/60 backdrop-blur-sm border border-gold/30 mb-8 animate-fade-up">
            ...
            <span className="text-sm font-medium text-foreground/80">
              Premium Beauty Studio in Kolkata
            </span>
          </div>
          ...
          <p className="max-w-2xl mx-auto text-muted-foreground mb-10 animate-fade-up delay-400">
            We specialize in advanced semi-permanent treatments designed to
            softly enhance your natural features and give you long-lasting
            confidence. From bridal makeup to nail artistry — let your beauty
            speak before words.
          </p>
          ...
          {/* Stats */}
          <div className="mt-8 grid grid-cols-3 gap-8 max-w-lg mx-auto animate-fade-up delay-600">
            <div className="text-center">
              <p className="font-script text-4xl text-foreground">500+</p>
              <p className="text-sm text-muted-foreground">Happy Brides</p>
            </div>
            <div className="text-center">
              <p className="font-script text-4xl text-foreground">5+</p>
              <p className="text-sm text-muted-foreground">Years Experience</p>
            </div>
            <div className="text-center">
              <p className="font-script text-4xl text-foreground">100%</p>
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 border-2 border-primary/50 rounded-full flex items-start justify-center p-2">
          <div className="w-1.5 h-3 bg-primary rounded-full animate-ping" />
        </div>
      </div>
    </section>
  );
